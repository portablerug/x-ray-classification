...
## Resume-Oriented Project Positioning

This repo is designed so your final outcomes can be summarized as:

> Developed an end-to-end machine learning pipeline using cloud-hosted NIH Chest X-ray data, programmatically querying metadata via BigQuery and training deep learning models to detect thoracic disease under class imbalance, improving recall for minority cases.

## Current Status

Template scaffold complete (structure-only).

No modeling or production code has been added yet.
